...
def main(
    ...
    like_item_weight_col = "620 Like Item Match.[Final Like Item Weight]"
    ...
    try:
        ...
        relevant_columns = [
            ...
            from_location,
            like_item,
            like_item_weight_col,
        ]

        relevant_like_item_mappings = new_item_customers[relevant_columns].drop_duplicates()

        # Replace NaN values in 'like_item_weight_col' with 1
        relevant_like_item_mappings[like_item_weight_col] = relevant_like_item_mappings[
            like_item_weight_col
        ].fillna(1)
        ...
        relevant_like_item_forecast[weighted_sum] = (
            ...
            * relevant_like_item_forecast[like_item_weight_col]
        )
        ...
        LikeItemForecast[weighted_average] = (
            LikeItemForecast[weighted_sum] / LikeItemForecast[like_item_weight_col]
        )

        # dropping extra columns
        LikeItemForecast.drop(columns=[like_item_weight_col], inplace=True)
        ...
        LikeItemForecast = pd.merge(
            LikeItemForecast,
            Parameters,
            on=merge_cols + [demand_domain_col],
            how="left",
        )
