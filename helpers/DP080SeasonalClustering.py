...
col_mapping = {
    "SCHM Seasonal Index": float,
    "SCHM Seasonality Level": str,
    "SCHM Cluster Label": float,
    "SCHM Validation Cluster Label": float,
    "SCHM Validation Seasonality Level": str,
    "SCHM Validation Seasonal Index": float,
}
...
def processIteration(
    ...
    All_CLUSTER_COLUMNS = [
        validation_seasonality_level,
        validation_cluster_label,
        validation_seasonal_index,
        seasonality_level,
        cluster_label,
        seasonal_index,
    ]
    ...
    try:
        ...
        all_validations_df = all_validations_df.rename(
            columns={
                seasonal_index: validation_seasonal_index,
                cluster_label: validation_cluster_label,
                seasonality_level: validation_seasonality_level,
            }
        )
        ...
        AllCluster = disaggregate_data(
            ...
            cols_to_disaggregate=[validation_seasonal_index, seasonal_index],
        )
