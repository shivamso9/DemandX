"""
Plugin : DP081BacktestSeasonalClustering
Version : 0.0.0
...
Input Queries:
    ...
    ItemMasterData : Select ([Item].[Stat Item] * [Item].[L1] * [Item].[L2] * [Item].[L3] * [Item].[L4] * [Item].[L5] * [Item].[L6]) on row,  () on column;
...
from helpers.DP081BacktestSeasonalClustering import main
...
ClusterOutput = main(
    ...
    BackTestCyclePeriod=int(BackTestCyclePeriod),
