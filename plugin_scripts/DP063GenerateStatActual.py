...
Input Queries:
    ...
    ForecastIterationSelection : Select ([Version].[Version Name] * [Region].[Planning Region] * [Item].[Planning Item] * [PnL].[Planning PnL] * [Forecast Iteration].[Forecast Iteration Type] * [Location].[Location] * [Demand Domain].[Planning Demand Domain] * [Account].[Planning Account] * [Channel].[Planning Channel] ) on row,  ({Measure.[Forecast Iteration Selection]}) on column;
    ...
    StatHistoryStartDate : Select ([Version].[Version Name] * [Region].[Planning Region] * [Location].[Planning Location].relatedmembers(Location) * [Channel].[Planning Channel] * [PnL].[Planning PnL] * [Item].[Planning Item] * [Demand Domain].[Planning Demand Domain] * [Account].[Planning Account] ) on row,  ({Measure.[Stat History Start Date]}) on column;
...
from helpers.DP063GenerateStatActual import main
...
StatHistoryStartDate = O9DataLake.get("StatHistoryStartDate")
