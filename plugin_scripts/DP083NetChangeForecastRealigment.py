"""
Plugin : DP083NetChangeForecastRealigment
Version : 0.0.0
Maintained by : dpref@o9solutions.com

Script Params:
    Grains - Item.[Planning Item],Location.[Planning Location],Account.[Planning Account],Region.[Planning Region],Channel.[Planning Channel],PnL.[Planning PnL],Demand Domain.[Planning Demand Domain]
...
Input Queries:
    ...
    RealignmentRules - Select ([Version].[Version Name] * [Data Object].[Data Object] * [DM Rule].[Rule] * [Sequence].[Sequence] ) on row,  ({Measure.[DP From Item Scope], Measure.[DP To Item Scope], Measure.[DP From Account Scope], Measure.[DP To Account Scope],
        ...
        Measure.[DP From Demand Domain Scope], Measure.[DP To Demand Domain Scope], Measure.[Forecast Realignment Status], Measure.[Realignment Net Change Flag], Measure.[DP From Item Scope LC], Measure.[DP To Item Scope LC], Measure.[DP From Account Scope LC],
        Measure.[DP To Account Scope LC], Measure.[DP From Channel Scope LC], Measure.[DP To Channel Scope LC], Measure.[DP From Region Scope LC], Measure.[DP To Region Scope LC] , Measure.[DP From Location Scope LC],  Measure.[DP To Location Scope LC],
         Measure.[DP From PnL Scope LC], Measure.[DP To PnL Scope LC], Measure.[DP From Demand Domain Scope LC], Measure.[DP To Demand Domain Scope LC]}) on column;

    AssortmentFinal - Select ([Version].[Version Name]  * [Item].[Item] * [Account].[Planning Account] * [Channel].[Planning Channel] * [Region].[Planning Region] * [PnL].[Planning PnL] * [Location].[Location] * [Demand Domain].[Planning Demand Domain] ) on row,
        ({Measure.[Assortment Final]}) on column;
...
from helpers.DP083NetChangeForecastRealignment import main
