"""
Plugin : DP082NetChangeHistoryRealignment
Version : 2025.08.00
...
Input Queries:
    ...
    RealignmentRules - Select ([Version].[Version Name] * [Data Object].[Data Object] * [DM Rule].[Rule] * [Sequence].[Sequence] ) on row,  ({Measure.[DP From Item Scope], Measure.[DP To Item Scope], Measure.[DP From Account Scope], Measure.[DP To Account Scope],
        ...
        Measure.[DP From Demand Domain Scope], Measure.[DP To Demand Domain Scope], Measure.[History Realignment Status], Measure.[Realignment Net Change Flag], Measure.[DP From Item Scope LC], Measure.[DP To Item Scope LC], Measure.[DP From Account Scope LC],
...
from helpers.DP082NetChangeHistoryRealignment import main
