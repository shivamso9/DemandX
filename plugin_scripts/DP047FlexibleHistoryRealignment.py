"""
Plugin : DP047FlexibleHistoryRealignment
Version : 2025.08.00
...
({Measure.[Actual Raw]}) on column).filter(Measure.[Candidate for History Realignment] == 1.0);
...
({Measure.[Actual Raw]}) on column).filter(coalesce(Measure.[Candidate for History Realignment],0) <> 1.0);
...
//RealignmentRules
Select ([Version].[Version Name] * [Data Object].[Data Object] * [DM Rule].[Rule] * [Sequence].[Sequence] ) on row,  ({Measure.[DP From Item Scope], Measure.[DP To Item Scope], Measure.[DP From Account Scope],
Measure.[DP To Account Scope], Measure.[DP From Channel Scope], Measure.[DP To Channel Scope], Measure.[DP From Region Scope], Measure.[DP To Region Scope] , Measure.[DP From Location Scope],Measure.[DP To Location Scope],
Measure.[DP From PnL Scope], Measure.[DP To PnL Scope], Measure.[DP From Demand Domain Scope], Measure.[DP To Demand Domain Scope], Measure.[DP Realignment Percentage],Measure.[DP Conversion Factor],Measure.[DP Full History Realignment Status],
Measure.[History Realignment Status],Measure.[DP Realignment Rule Sequence],Measure.[Transition Start Date], Measure.[History Realignment Active Period]}) on column;
...
from helpers.DP047FlexibleHistoryRealignment import main
