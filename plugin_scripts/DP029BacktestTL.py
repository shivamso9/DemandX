...
Script Params:
    ...
    InputTables - Actuals,SellOutActual
...
Input Queries:
    ...
    Actuals : Select ([Sequence].[Sequence]* [Forecast Iteration].[Forecast Iteration] *[Account].[Planning Account] * [Channel].[Planning Channel] * [Region].[Planning Region] * [PnL].[Planning PnL] * [Demand Domain].[Planning Demand Domain] * [Demand Domain].[Transition Demand Domain] * [Location].[Planning Location] * [Location].[Location] * [Version].[Version Name] * [Item].[Planning Item] * [Item].[Transition Item] * [Time].[Partial Week]) on row,  ({Measure.[Actual], Measure.[Assortment Stat],Measure.[Slice Association TL]}) on column where {(Measure.[Assortment Stat]>0)};
    ...
    DemandDomainMasterData : select ([Demand Domain].[All Demand Domain] * [Demand Domain].[Demand Domain L1] * [Demand Domain].[Demand Domain L2] *[Demand Domain].[Demand Domain L3] * [Demand Domain].[Demand Domain L4] * [Demand Domain].[Transition Demand Domain] *  [Demand Domain].[Planning Demand Domain]) on row, () on column include_nullmembers;
    ...
    ForecastParameters : Select ([Forecast Iteration].[Forecast Iteration] * [Version].[Version Name] ) on row, ({Measure.[History Period]}) on column;

    StatFcstL1Lag1 : Select ([Version].[Version Name] * [Time].[Partial Week] * [Region].[Stat Region] * [Item].[Stat Item] * [PnL].[Stat PnL] * [Forecast Iteration].[Forecast Iteration] * [Location].[Stat Location] * [Demand Domain].[Stat Demand Domain] * [Account].[Stat Account] * [Channel].[Stat Channel] ) on row,  ({Measure.[Stat Fcst L1 Lag1 Backtest]}) on column;

    StatFcstL1WLag : Select ([Version].[Version Name] * [Time].[Week] * [Region].[Stat Region] * [Item].[Stat Item] * [PnL].[Stat PnL] * [Forecast Iteration].[Forecast Iteration] * [Location].[Stat Location] * [Planning Cycle].[Planning Cycle Date] * [Lag].[Lag] * [Demand Domain].[Stat Demand Domain] * [Account].[Stat Account] * [Channel].[Stat Channel] ) on row,  ({Measure.[Stat Fcst L1 W Lag Backtest]}) on column;

    StatFcstL1MLag : Select ([Version].[Version Name] * [Time].[Month] * [Region].[Stat Region] * [Item].[Stat Item] * [PnL].[Stat PnL] * [Forecast Iteration].[Forecast Iteration] * [Location].[Stat Location] * [Planning Cycle].[Planning Cycle Date] * [Lag].[Lag] * [Demand Domain].[Stat Demand Domain] * [Account].[Stat Account] * [Channel].[Stat Channel] ) on row,  ({Measure.[Stat Fcst L1 M Lag Backtest]}) on column;

    StatFcstL1PMLag : Select ([Version].[Version Name] * [Time].[Planning Month] * [Region].[Stat Region] * [Item].[Stat Item] * [PnL].[Stat PnL] * [Forecast Iteration].[Forecast Iteration] * [Location].[Stat Location] * [Planning Cycle].[Planning Cycle Date] * [Lag].[Lag] * [Demand Domain].[Stat Demand Domain] * [Account].[Stat Account] * [Channel].[Stat Channel] ) on row,  ({Measure.[Stat Fcst L1 PM Lag Backtest]}) on column;

    StatFcstL1QLag : Select ([Version].[Version Name] * [Time].[Quarter] * [Region].[Stat Region] * [Item].[Stat Item] * [PnL].[Stat PnL] * [Forecast Iteration].[Forecast Iteration] * [Location].[Stat Location] * [Planning Cycle].[Planning Cycle Date] * [Lag].[Lag] * [Demand Domain].[Stat Demand Domain] * [Account].[Stat Account] * [Channel].[Stat Channel] ) on row,  ({Measure.[Stat Fcst L1 Q Lag Backtest]}) on column;

    StatFcstL1PQLag : Select ([Version].[Version Name] * [Time].[Planning Quarter] * [Region].[Stat Region] * [Item].[Stat Item] * [PnL].[Stat PnL] * [Forecast Iteration].[Forecast Iteration] * [Location].[Stat Location] * [Planning Cycle].[Planning Cycle Date] * [Lag].[Lag] * [Demand Domain].[Stat Demand Domain] * [Account].[Stat Account] * [Channel].[Stat Channel] ) on row,  ({Measure.[Stat Fcst L1 PQ Lag Backtest]}) on column;

    TItemDates : Select ([Version].[Version Name] * [Account].[Planning Account] * [Channel].[Planning Channel] * [Region].[Planning Region] * [PnL].[Planning PnL] * [Location].[Planning Location] * [Demand Domain].[Transition Demand Domain] * [Item].[Transition Item]) on row, ({ Measure.[Disco Date]}) on column;
    ...
    SellOutActual :  Select ([Sequence].[Sequence]* [Forecast Iteration].[Forecast Iteration] * [Version].[Version Name] * [Time].[Partial Week] * [Account].[Planning Account] * [Item].[Planning Item] * [Item].[Transition Item] * [Location].[Location] * [Location].[Planning Location] * [Region].[Planning Region] * [Channel].[Planning Channel] * [PnL].[Planning PnL] * [Demand Domain].[Planning Demand Domain] * [Demand Domain].[Transition Demand Domain] ) on row,  ({ Measure.[Sell Out Actual 1], Measure.[Slice Association TL]}) on column include memberproperties {Time.[Partial Week],Key} where {~isnull(Measure.[Sell Out Actual 1]), (Measure.[Slice Association TL] == 1)} ;
...
from helpers.DP029BacktestL1 import main
...
StatFcstL1Lag1 = O9DataLake.get("StatFcstL1Lag1")
...
TItemFcstLag, LagModelOutput = main(
    CurrentTimePeriod=CurrentTimePeriod,
    Actuals=CombinedActual,
...
O9DataLake.put("TItemFcstLag", TItemFcstLag)
