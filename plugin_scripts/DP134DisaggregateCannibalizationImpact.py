"""
    Plugin Information:
    --------------------
		Plugin : DP134DisaggregateCannibalizationImpact
		Version : 0.0.0
    ...
    Input Queries:
    --------------------
        SelectedInitiativeLevel : Select ([Version].[Version Name] * [Initiative].[Initiative] * [Data Object].[Data Object] ) on row, ({Measure.[Cannib Impact Disaggregation Flag L1]}) on column where {Measure.[Cannib Impact Disaggregation Flag] == 1};
        ...
        CannibImpact : Select ([Version].[Version Name] * [Time].[Partial Week] * [Region].[NPI Region] * [PnL].[NPI PnL] * [Location].[NPI Location] * [Item].[NPI Item] * [Initiative].[Initiative] * [Demand Domain].[NPI Demand Domain] * [Data Object].[Data Object] * [Channel].[NPI Channel] * [Account].[NPI Account] ) on row, ({Measure.[Cannibalization Impact Final L0]}) on column;

        CannibImpactPlanningLevel : Select ([Version].[Version Name] * [Initiative].[Initiative] * [Data Object].[Data Object] * [Item].[Planning Item] * [Account].[Planning Account] * [Channel].[Planning Channel] * [Region].[Planning Region] * [PnL].[Planning PnL] * [Location].[Planning Location] * [Demand Domain].[Planning Demand Domain] * [Time].[Partial Week] ) on row, ({Measure.[Planning Level Cannibalization Impact]}) on column;

        Splits : Select ([Version].[Version Name] * [Account].[Planning Account] * [Channel].[Planning Channel] * [Data Object].[Data Object] * [Demand Domain].[Planning Demand Domain] * [Initiative].[Initiative] * [Item].[Planning Item] * [Location].[Planning Location] * [PnL].[Planning PnL] * [Region].[Planning Region] ) on row, ({Measure.[Cannib Final Split %]}) on column;
...
from helpers.DP134DisaggregateCannibalizationImpact import main
...
CannibImpact = O9DataLake.get("CannibImpact")
...
CannibImpactPlanningLevel = O9DataLake.get("CannibImpactPlanningLevel")
...
# Save Output Data
O9DataLake.put("PlanningImpact", PlanningImpact)
