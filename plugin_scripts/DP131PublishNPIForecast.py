"""
    Plugin Information:
    --------------------
        Plugin : DP131PublishNPIForecast
        Version : 0.0.0
        Maintained by : dpref@o9solutions.com

    Script Params:
    --------------------
        TimeKeyFormat = None # Date time format of Dim Time key.
        MeasureDateFormat = None # Date time format of Measures.

    Input Queries:
    --------------------
        SelectedCombinations: Select ([Version].[Version Name] * [Data Object].[Data Object] * [Initiative].[Initiative] ) on row, ({Measure.[NPI Forecast Publish Flag L1]}) on column;

        InitiativeLevels: Select ([Version].[Version Name] * &AllNPIInitiative * &AllNPILevel ) on row, ({Measure.[NPI Item Level],Measure.[NPI Account Level], Measure.[NPI Channel Level], Measure.[NPI Region Level], Measure.[NPI PnL Level], Measure.[NPI Demand Domain Level], Measure.[NPI Location Level], Measure.[NPI Level Sequence L1]}) on column;

        Parameters: Select ([Version].[Version Name] * &AllNPIInitiative * &AllNPILevel * &AllNPIItem * &AllNPIAccount * &AllNPIChannel * &AllNPIRegion * &AllNPIPnL * &AllNPIDemandDomain * &AllNPILocation ) on row, ({Measure.[NPI Association L0],Measure.[Start Date L0],Measure.[End Date L0],Measure.[Independence Date Final L0]}) on column;

        NPIFcst: Select ([Version].[Version Name] * [Initiative].[Initiative] * [Data Object].[Data Object] * [Item].[Planning Item] * [Account].[Planning Account] * [Channel].[Planning Channel] * [Region].[Planning Region] * [PnL].[Planning PnL] * [Location].[Planning Location] * [Demand Domain].[Planning Demand Domain] * [Time].[Partial Week] ) on row, ({Measure.[Planning Level NPI Fcst]}) on column;
        ...
        NPIAssortmentFinal: Select ([Version].[Version Name] * [Initiative].[Initiative] * [Data Object].[Data Object] * [Item].[Item]  * [Item].[Planning Item] * [Location].[Location] * [Location].[Planning Location] * [Account].[Planning Account] * [Channel].[Planning Channel] * [Region].[Planning Region] * [PnL].[Planning PnL] * [Demand Domain].[Planning Demand Domain] ) on row, ({Measure.[NPI Assortment Final by Level]}) on column;
...
from helpers.DP131PublishNPIForecast import main
...
(PlanningFcstOutput, DatesOutput, AssortmentNewOutput, AssortmentInactiveOutput) = main(
    # Data
    ...
    MeasureDateFormat=MeasureDateFormat,
...
O9DataLake.put("DatesOutput", DatesOutput)
O9DataLake.put("AssortmentNewOutput", AssortmentNewOutput)
O9DataLake.put("AssortmentInactiveOutput", AssortmentInactiveOutput)
