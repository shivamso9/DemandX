...
Input Queries:
    ...
    SellInForecast_Raw - Select ([Version].[Version Name] * [Time].[Partial Week] * [Region].[Planning Region] * [Item].[Planning Item] * [PnL].[Planning PnL] * [Location].[Planning Location] * [Channel].[Planning Channel] * [Account].[Planning Account] * [Demand Domain].[Planning Demand Domain] ) on row, ({Measure.[Cannibalization Impact FND BB], Measure.[Cannibalization Impact Published FND BB Raw], Measure.[Cannibalized Stat Fcst L0 FND BB Raw], Measure.[Fcst Adjustment 1 FND BB], Measure.[Fcst Adjustment 2 FND BB], Measure.[Fcst Adjustment 3 FND BB], Measure.[Fcst Adjustment 4 FND BB], Measure.[Fcst Adjustment 5 FND BB], Measure.[Fcst Adjustment 6 FND BB], Measure.[NPI Fcst FND BB], Measure.[NPI Fcst Published FND BB Raw], Measure.[Stat Fcst FND BB Raw], Measure.[Stat Fcst L0 FND BB Raw], Measure.[Stat Fcst L0 Override FND BB]}) on column;
    ...
    Actuals - Select ([Version].[Version Name] * [Region].[Region] * [Item].[Item] * [PnL].[PnL] * [Location].[Location] * [Channel].[Channel] * [Account].[Account] * [Demand Domain].[Demand Domain] * &AllDays.Filter(#.Key <= &CurrentDay.element(0).LeadOffset(-1).Key && #.Key >= &CurrentDay.element(0).LeadOffset(-180).Key).relatedmembers([Partial Week])) on row,  ({Measure.[Actual]}) on column include memberproperties {Time.[Partial Week], Key};

    SellOutForecast_Raw - Select ([Version].[Version Name] * [Time].[Partial Week] * [Region].[Planning Region] * [Item].[Planning Item] * [Channel].[Planning Channel] * [Account].[Planning Account] * [Demand Domain].[Planning Demand Domain]) on row,  ({Measure.[Sell Out Forecast Adjustment 1 FND BB], Measure.[Sell Out Forecast Adjustment 2 FND BB], Measure.[Sell Out Forecast Adjustment 3 FND BB], Measure.[Sell Out Forecast Adjustment 4 FND BB], Measure.[Sell Out Forecast Adjustment 5 FND BB], Measure.[Sell Out Forecast Adjustment 6 FND BB], Measure.[Sell Out Stat Fcst KAF BB New FND BB Raw], Measure.[Sell Out Stat Fcst New FND BB Raw], Measure.[Sell Out Stat Fcst Override FND BB], Measure.[Sell In FND BB Raw]}) on column;
...
SellInForecast_Raw = O9DataLake.get("SellInForecast_Raw")
KeyFigures = O9DataLake.get("KeyFigures")
Actuals = O9DataLake.get("Actuals")
SellOutForecast_Raw = O9DataLake.get("SellOutForecast_Raw")
...
from helpers.DP080ForecastRealignment import main
...
(
    ...
    SellInForecast_Raw=SellInForecast_Raw,
    KeyFigures=KeyFigures,
    Actuals=Actuals,
    SellOutForecast_Raw=SellOutForecast_Raw,
...
O9DataLake.put("RealignedForecastSellIn", RealignedForecastSellIn)
O9DataLake.put("RealignedForecastSellOut", RealignedForecastSellOut)
...
O9DataLake.put("RawSellInOverrideOutput", RawSellInOverrideOutput)
O9DataLake.put("RawSellOutOverrideOutput", RawSellOutOverrideOutput)
