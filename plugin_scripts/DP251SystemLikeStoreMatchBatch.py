"""
Plugin : DP051SystemLikeStoreMatchBatch
Version : 0.0.0
...
Input Queries:
    ...
    Assortment : Select ([Version].[Version Name] * [Location].[Location] ) on row,  ({Measure.[New Store for Like Store Match Batch Flag]}) on column;
...
from ds_ref_lib.plugin_helpers.nsi.like_store_determination.multiple_groups import main
