"""
Plugin : DP047FlexibleHistoryRealignment_Sell_In
Version : 2025.08.00
Maintained by : dpref@o9solutions.com

Input Queries:
//Full Actual
(Select ([Version].[Version Name] * [Time].[Week] * [Time].[Day] * [Region].[Region] * [Item].[Item] * [Location].[Location] * [Demand Domain].[Demand Domain] * [Account].[Account] * [Channel].[Channel] * [PnL].[PnL] ) on row,
({Measure.[Actual Raw],Measure.[Billing Raw],Measure.[Orders Raw],Measure.[Shipments Raw]}) on column).filter(Measure.[Candidate for History Realignment] == 1.0);

// Actual
(Select ([Version].[Version Name] * [Time].[Week] * &HistoryRefreshBuckets * [Region].[Region] * [Item].[Item] * [Location].[Location] * [Demand Domain].[Demand Domain] * [Account].[Account] * [Channel].[Channel] * [PnL].[PnL] ) on row,
({Measure.[Actual Raw],Measure.[Billing Raw],Measure.[Orders Raw],Measure.[Shipments Raw]}) on column).filter(coalesce(Measure.[Candidate for History Realignment],0) <> 1.0);

//AttributeMapping
Select ([Version].[Version Name] * [Data Object].[Data Object] ) on row,  ({Measure.[Data Object Account Level], Measure.[Data Object Channel Level], Measure.[Data Object Item Level], Measure.[Data Object Location Level],
Measure.[Data Object Region Level], Measure.[Data Object PnL Level], Measure.[Data Object Demand Domain Level]}) on column;

//RealignmentRules
Select ([Version].[Version Name] * [Data Object].[Data Object] * [DM Rule].[Rule] * [Sequence].[Sequence] ) on row,  ({Measure.[DP From Item Scope], Measure.[DP To Item Scope], Measure.[DP From Account Scope], Measure.[DP To Account Scope],
Measure.[DP From Channel Scope], Measure.[DP To Channel Scope], Measure.[DP From Region Scope], Measure.[DP To Region Scope] , Measure.[DP From Location Scope],Measure.[DP To Location Scope],Measure.[DP From PnL Scope], Measure.[DP To PnL Scope],
Measure.[DP From Demand Domain Scope], Measure.[DP To Demand Domain Scope], Measure.[DP Realignment Percentage],Measure.[DP Conversion Factor],Measure.[DP Full History Realignment Status],Measure.[History Realignment Status System],
Measure.[DP Realignment Rule Sequence],Measure.[Transition Start Date], Measure.[History Realignment Active Period]}) on column;
...
// KeyFigures
Select ([Version].[Version Name] * [Data Object].[Data Object Type].[Sell In History Measures] * [Data Object].[Data Object] ) on row, ({Measure.[Include in History Realignment]}) on column;
